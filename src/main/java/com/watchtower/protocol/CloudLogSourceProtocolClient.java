...
/**
 * Protocol client that enables function discovery and execution.
 ...
 */
public class CloudLogSourceProtocolClient implements CloudLogSource {
    ...
    public CloudLogSourceProtocolClient(String host, int port) throws IOException {
    ...
    protected CloudLogSourceProtocolClient(Socket socket, BufferedReader reader, PrintWriter writer) {
        this.socket = socket;
        this.reader = reader;
        this.writer = writer;
    }
